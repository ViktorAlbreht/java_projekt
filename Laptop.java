...
class App {
    public static void main(String[] args) throws Exception {
        Laptop laptop1 = new Laptop("Lenovo IdealPad 15", 8, 512, "Windows 11", "синий", 15.6);
        Laptop laptop2 = new Laptop("Honor MagicBook 16", 16, 512, "Windows 10", "серый", 16.2);
        Laptop laptop3 = new Laptop("Apple MacBook Air 13", 8, 256, "MacOs", "золотистый", 13.3);
        Laptop laptop4 = new Laptop("HP Pavilion 15", 4, 1024, "без ОС", "черный", 15.6);
        Laptop laptop5 = new Laptop("MSI Modern 17", 8, 256, "без ОС", "чёрный", 17.3);
        Laptop laptop6 = new Laptop("Honor MagicBook 14", 8, 512, "Windows 10", "серебристый", 14);
        Laptop laptop7 = new Laptop("ASUS ExpertBook 15", 4, 1024, "Windows 10", "чёрный", 15.6);
        Laptop laptop8 = new Laptop("Acer Extensa 15", 4, 256, "Windows 11", "чёрный", 15.6);
        Laptop laptop9 = new Laptop("ASUS Vivobook 15", 8, 512, "Windows 11", "серый", 15.6);
